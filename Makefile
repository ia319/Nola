...
.PHONY: help setup install \
	...
	release-set-version release-check-version release-clean release-install-core-build release-build-core-windows release-package-windows-portable release-checksums \
