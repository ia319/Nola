...
export function FileUploader({ onFilesSelected, disabled = false }: FileUploaderProps) {
  ...
  return (
    <div
      ...
      className={`focus-visible:ring-ring flex cursor-pointer flex-col items-center justify-center gap-4 rounded-xl border-2 border-dashed p-8 transition-colors duration-200 focus-visible:ring-2 focus-visible:outline-none ${
        isDragOver
